...
var AllCorrPage = React.createClass({
        ...
        return (
            <div className="row">
                <div className="col-md-12">
                    <components.QueryResultsPanel panelHeading={"Correspondents Owed Email (last 6 months)"}
                        queryResult={this.getQueryResult('correspondentsOwedMail')} 
                        />
                </div>
            </div>
            );
    ...
    componentDidMount: function() {
        ...
        this.getFlux().actions.evalQuery('correspondentsOwedMail');
    }
