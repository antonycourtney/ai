...
var AllCorrPage = React.createClass({
        ...
        return (
            <div className="row">
                <div className="col-md-12">
                    <components.QueryResultsPanel panelHeading={"Correspondents You Haven't Contacted in a While"}
                        queryResult={this.getQueryResult('lostTouch')} 
                        />
                </div>
            </div>
            );
    ...
    componentDidMount: function() {
        ...
        this.getFlux().actions.evalQuery('lostTouch');
    }
